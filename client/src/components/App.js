...
import MainFeedPage from './dashboard/Main_Feed_Page';
    ...
    return (
      <React.Fragment>
        ...
        <Switch>
          ...
          <AuthRoute path={'/tag-feed/:tagId'} component={TagFeedPage} />
          <AuthRoute path={['/dashboard', '/likes']} component={MainFeedPage} />
